...
class PJFDataset(Dataset):
    ...
    def build(self):
        ...
        if self.label_field in datasets[0].inter_feat.columns and not self.config['REMAIN_NEG']:
            datasets[0].inter_feat = datasets[0].inter_feat[datasets[0].inter_feat[self.label_field] == 1]

        if self.label_field in datasets[1].inter_feat.columns:
            datasets[1].inter_feat = datasets[1].inter_feat[datasets[1].inter_feat[self.label_field] == 1]
            datasets[2].inter_feat = datasets[2].inter_feat[datasets[2].inter_feat[self.label_field] == 1]
