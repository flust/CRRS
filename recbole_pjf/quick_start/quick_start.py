...
def run_recbole_pjf(model=None, dataset=None, config_file_list=None, config_dict=None, saved=True):
    ...
    # valid_str = set_color('For side A: ', 'green') + f'{best_valid_result['For side A']}'[11:] \
                    # + set_color('\nFor side B: ', 'green') + f'{best_valid_result['\nFor side B']}'[11:]
    test_str = set_color('For side A: ','green') + f'{test_result[0]}'[11:] \
                    + set_color('\nFor side B: ', 'green') + f'{test_result[1]}'[11:]
